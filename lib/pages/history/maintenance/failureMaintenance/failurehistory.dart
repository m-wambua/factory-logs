...
import 'package:collector/pages/history/maintenance/failureMaintenance/failureDetailsPage.dart';
import 'package:collector/pages/history/maintenance/failureMaintenance/failureEntry.dart'
    as FailureEntry;
...
class FailureHistory extends StatefulWidget {
  ...
  const FailureHistory({super.key, required this.subprocess});
  @override
...
class _FailureHistoryState extends State<FailureHistory> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Failure Maintenance Checklist'),
      ),
        ...
        DataCell(SizedBox.expand(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const FailureDetailsPage()));
          },
        ))),
